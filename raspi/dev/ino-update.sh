...
sudo avrdude   -C "${REPO_DIR}/scan-controller/avrdude_gpio.conf"   -p atmega328p   -c raspberry_pi_gpio   -P gpiochip0   -U flash:w:"${REPO_DIR}/scan-controller/build/arduino.avr.pro/scan-controller.ino.with_bootloader.hex":i
